...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">存储银行</span>
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="start" name="start" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间"id="end" name="end" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>存款人爱好：</td>
								<td>
									<input type="checkbox" id="pLike" name="pLike" value="名表"
									 aria-required="true" required/>名表
									 
									 <input type="checkbox" id="pLike" name="pLike" value="豪车"
									 aria-required="true" required/>豪车
									 
									 <input type="checkbox" id="pLike" name="pLike" value="美女"
									 aria-required="true" required/>美女
									 
									 <input type="checkbox" id="pLike" name="pLike" value="帅哥"
									 aria-required="true" required/>帅哥
									
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款人性别：</td>
								<td>
									<input type="radio" id="pSex" name="pSex" value="男"
	...
	function initEditUser(getSelection){
		...
		for (var i = 0; i < b.length; i++) {
			$("input[value="+b[i]+"]").prop("checked",true);
		}
	...
	$("#btn_exp").click(function(){
		location.href="${path}/person/exp.htm"
	});
