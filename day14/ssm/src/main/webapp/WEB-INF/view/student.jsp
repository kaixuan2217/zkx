...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="teacherid" id = "txt_search_teacherid">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>所属年级：</td>
								<td>
									<select id="grade" name="grade" class="form-control" aria-required="true" required>
										<option value="0">---请选择---</option>
							...
							<tr>
								...
								<td>入校时间</td>
								<td>
									<input type="date" name="entrytime" id="entrytime" aria-required="true" required>
								</td>
							</tr>
						</table>
	...
	<div class="modal fade" id="modal_user_addTeacher" role="dialog" aria-labelledby="modal_user_addTeacher" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
				<form action="reserveTeacher.htm" id="form_teacher" method="post">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>老师名：</td>
								<td><input type="text" id="name" name="name"
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form_import"method="post" action="importStudent.htm" enctype="multipart/form-data">
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_user_export" rexporole="dialog" aria-labelledby="modal_user_export" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            teacherid: $("#txt_search_teacherid").val(),
