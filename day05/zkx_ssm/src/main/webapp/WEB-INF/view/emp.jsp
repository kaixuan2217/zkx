					...
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>员工生日：</td>
								<td>
								<input type="date" placeholder="开始时间" id="txt_search_birthday" name="birthday" />
								</td>
							</tr>
							<tr>
								<td>性别：</td>
							...
							<tr>
								<td>头像：</td>
								<td>
									<img alt="" src="" id="pics"width="100px" height="100px">
								...
								<td>
									...
									<input type="checkbox" id="hobby3" name="hobby" value="排球">排球
								</td>
							</tr>
							<tr>
								<td>员工部门：</td>
